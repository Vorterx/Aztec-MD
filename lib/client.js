...
return m.reply("*The bot only works in group chats. Please use the bot within a group context...*");
    ...
    command.client(vorterx, m, { name: "vorterx", pushName: m.pushName, arg, args, isAdmin, isBotAdmin, mentionByTag, participants, text, mime, connect, quoted, mode: mode.get(),});
  }
  } catch (err) {
  console.log(err, 'red')
  }
